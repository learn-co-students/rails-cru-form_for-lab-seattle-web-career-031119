...
describe 'form' do
  it 'shows a new genre form that submits content and redirects and prints out params' do
  ...
  it 'shows a genre edit form that submits content and redirects and prints out params' do
    @genre = Genre.create(name: "My Genre")
